...
import { useCustomerAddressLookup } from "@/hooks/use-lookup"
...
export default function AddressAutocomplete<T extends Record<string, unknown>>({
  form,
  label,
  name,
  customerId,
  ...
  isDisabled?: boolean
  isRequired?: boolean
  onChangeEvent?: (selectedOption: ICustomerAddress | null) => void
}) {
  const {
    data: addresses = [],
    isLoading,
    refetch,
  } = useCustomerAddressLookup(customerId)
  ...
  const handleChange = React.useCallback(
    ...
    [form, name, onChangeEvent, addresses]
  )
