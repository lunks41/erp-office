...
const employmentTypeOptions: FieldOption[] = [
...
export default function EmploymentTypeAutocomplete<
...
>({
  ...
  const baseOptions = employmentTypeOptions
...
const handleChange = wrapOnChange(
  ...
  const getValue = React.useCallback(() => {
    if (form && name) {
      ...
      return (
        employmentTypeOptions.find((option) => option.value === formValue) ||
        null
      )
    }
    return null
