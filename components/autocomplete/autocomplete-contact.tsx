...
import { useCustomerContactLookup } from "@/hooks/use-lookup"
import { FormField, FormItem } from "@/components/ui/form"
import { Label } from "@/components/ui/label"

type FieldOption = SearchableFieldOption

export default function ContactAutocomplete<T extends Record<string, unknown>>({
  form,
  label,
  name,
  customerId,
  ...
  isDisabled?: boolean
  isRequired?: boolean
  onChangeEvent?: (selectedOption: ICustomerContact | null) => void
}) {
  const {
    data: contacts = [],
    isLoading,
    refetch,
  } = useCustomerContactLookup(customerId)
...
const handleChange = wrapOnChange(
    ...
    [form, name, onChangeEvent, contacts, markOptionSelected]
    )
  )
