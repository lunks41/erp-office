...
import { useRepaymentStatusLookup } from "@/hooks/use-lookup"
import { FormField, FormItem } from "@/components/ui/form"
import { Label } from "@/components/ui/label"

type FieldOption = SearchableFieldOption

export default function RepaymentStatusAutocomplete<
...
>({
  ...
  const { data: statusTypes = [], isLoading } = useRepaymentStatusLookup()
