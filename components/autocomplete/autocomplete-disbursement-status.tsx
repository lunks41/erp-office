...
import { useDisbursementLookup } from "@/hooks/use-lookup"
...
export default function DisbursementStatusAutocomplete<
...
>({
  ...
  const { data: statusTypes = [], isLoading } = useDisbursementLookup()
