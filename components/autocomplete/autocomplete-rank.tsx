...
import { useRankLookup } from "@/hooks/use-lookup"
...
export default function RankAutocomplete<T extends Record<string, unknown>>({
  form,
  label,
  name,
  isDisabled = false,
...
const handleChange = wrapOnChange(
    ...
    [form, name, onChangeEvent, ranks, markOptionSelected]
    )
  )
