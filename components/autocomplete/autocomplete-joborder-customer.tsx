...
import { useJobOrderCustomerLookup } from "@/hooks/use-lookup"
...
export default function JobOrderCustomerAutocomplete<
...
>({
  ...
  const {
    ...
    isLoading,
    refetch,
  } = useJobOrderCustomerLookup(customerId, jobOrderId)
...
const handleChange = wrapOnChange(
    ...
    [form, name, onChangeEvent, jobOrders, markOptionSelected]
    )
  )
