...
import { useApprovalStatusTypeLookup } from "@/hooks/use-lookup"
...
export default function ApprovalStatusAutocomplete<
...
>({
  ...
  const { data: statusTypes = [], isLoading } = useApprovalStatusTypeLookup()
