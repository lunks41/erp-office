...
export default function CurrentYearAutocomplete<
...
>({
  ...
  const { data: currentYears = [], isLoading } = useCurrentYearLookup()
  ...
  const handleChange = React.useCallback(
    (option: SingleValue<FieldOption> | MultiValue<FieldOption>) => {
      ...
      if (onChangeEvent) {
        const selectedCurrentYear = selectedOption
          ? currentYears.find(
              (u: IYearLookup) => u.yearId.toString() === selectedOption.value
            ) || null
          : null
        onChangeEvent(selectedCurrentYear)
      }
    },
    [form, name, onChangeEvent, currentYears, markOptionSelected]
  )
              ...
              <FormItem className={cn("flex flex-col", className)}>
                <div ref={selectControlRef} onKeyDown={handleKeyDown}>
                  <Select
                    ...
                    placeholder="Select CurrentYear..."
