...
interface DocumentTypesTableProps {
  ...
  onDeleteAction?: (documentTypeId: string) => void
  onEditAction?: (documentType: IDocumentType) => void
  onCreateAction?: () => void
...
export function DocumentTypesTable({
  ...
  const columns: ColumnDef<IDocumentType>[] = [
    {
      accessorKey: "docTypeCode",
      header: "Code",
