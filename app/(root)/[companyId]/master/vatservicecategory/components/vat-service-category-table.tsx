...
interface VATServiceCategoriesTableProps {
  data: IVATServiceCategory[]
  isLoading?: boolean
  totalRecords?: number
  onSelect?: (vatServiceCategory: IVATServiceCategory | null) => void
  onDeleteAction?: (vatServiceCategoryId: string) => void
  onEditAction?: (vatServiceCategory: IVATServiceCategory) => void
  onCreateAction?: () => void
...
export function VATServiceCategoriesTable({
  data,
  isLoading = false,
  totalRecords = 0,
  onSelect,
