...
export function LaunchServicesTab({
  ...
  // Clone single Launch Service confirmation state
  const [cloneSaveConfirmation, setCloneSaveConfirmation] = useState<{
    isOpen: boolean
    sourceItem: ILaunchService | null
  }>({
    isOpen: false,
    sourceItem: null,
  })
  ...
  const handleCloneRow = useCallback((item: ILaunchService) => {
  ...
  const handleCloneTask = async () => {
    ...
    try {
      ...
      const cloneData = {
        ...
        fromTaskId: Task.LaunchServices,
  ...
  const handlePurchase = useCallback(
    (launchServiceId: string) => {
      const item = data?.find(
        (service) => service.launchServiceId.toString() === launchServiceId
      )
  ...
  return (
    <>
      ...
      <SaveConfirmation
        ...
        title="Clone Launch Service"
        itemName={`Launch Service ${
        ...
        onConfirm={async () => {
          ...
          const submitData: LaunchServiceSchemaType = {
            ...(src as unknown as LaunchServiceSchemaType),
            launchServiceId: 0,
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        ...
        >
          ...
          {modalMode === "edit" || modalMode === "view" ? (
            <Tabs defaultValue="launchService">
              <TabsList className="mb-3">
                <TabsTrigger value="launchService">Launch Services</TabsTrigger>
                <TabsTrigger value="transportation">Transportation</TabsTrigger>
              </TabsList>

              <TabsContent value="launchService">
                <LaunchServiceForm
                  jobData={jobData}
