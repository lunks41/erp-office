...
export interface CbGenPaymentDetailsFormRef {
  recalculateAmounts: (
    exchangeRate?: number,
...
const CbGenPaymentDetailsForm = React.forwardRef<
...
>(
  (
    ...
    const onSubmit = async (_data: CbGenPaymentDtSchemaType) => {
      try {
...
CbGenPaymentDetailsForm.displayName = "CbGenPaymentDetailsForm"

export default CbGenPaymentDetailsForm
