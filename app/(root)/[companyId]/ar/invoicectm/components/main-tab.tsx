...
interface MainProps {
  ...
  companyId: number
  isCancelled?: boolean
  detailsFormRef?: React.RefObject<InvoiceCtmDetailsFormRef | null>
}
...
export default function Main({
  ...
  const handleDetailsFormRef = (
    instance: InvoiceCtmDetailsFormRef | null
  ) => {
  ...
  const handleClone = (detail: IArInvoiceCtmDt) => {
    const currentData =
      (form.getValues("data_details") as unknown as IArInvoiceCtmDt[]) || []
    ...
    const clonedDetail: IArInvoiceCtmDt = {
      ...detail,
      itemNo: nextItemNo,
      seqNo: nextItemNo,
    ...
    setEditingDetail(clonedDetail as unknown as ArInvoiceCtmDtSchemaType)
    setTableKey((prev) => prev + 1)
  }
  ...
  return (
    <div className="w-full">
      ...
      <InvoiceDetailsTable
        ...
        onCloneAction={handleClone as (template: IArInvoiceCtmDt) => void}
