...
export default function AdjustmentPage() {
    ...
    try {
      ...
      if (!validationResult.success) {
        ...
        validationResult.error.issues.forEach((error) => {
          ...
          const fieldPath = pathKey as keyof ArAdjustmentHdSchemaType
  ...
  const handlePrintAdjustment = () => {
    ...
    const reportData = {
      reportFile: "ar/ArAdjustment.trdp",
  ...
  const transformToSchemaType = useCallback(
    (apiAdjustment: IArAdjustmentHd): ArAdjustmentHdSchemaType => {
      return {
    ...
    async ({
      ...
      try {
        const response = await getById(
          `${ArAdjustment.getByIdNo}/${requestAdjustmentId}/${requestAdjustmentNo}`
        )
