...
export default function Main({
  ...
  const handleClone = (detail: IArAdjustmentDt) => {
    const currentData =
      (form.getValues("data_details") as unknown as IArAdjustmentDt[]) || []
    ...
    const clonedDetail: IArAdjustmentDt = {
      ...detail,
      itemNo: nextItemNo,
      seqNo: nextItemNo,
    ...
    setEditingDetail(clonedDetail as unknown as ArAdjustmentDtSchemaType)
    setTableKey((prev) => prev + 1)
  }
  ...
  return (
    <div className="w-full">
      ...
      <AdjustmentDetailsTable
        ...
        onCloneAction={handleClone as (template: IArAdjustmentDt) => void}
