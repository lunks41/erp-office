...
>(
  (
    ...
    // Uses reusable helper function from ar-adjustment-calculations
    ...
    const onSubmit = async (_data: ArAdjustmentDtSchemaType) => {
      try {
        ...
        const rowData: IArAdjustmentDt = {
          ...
          suppAdjustmentNo: updatedData.suppAdjustmentNo ?? "",
          apAdjustmentId: updatedData.apAdjustmentId ?? "0",
          apAdjustmentNo: updatedData.apAdjustmentNo ?? "",
