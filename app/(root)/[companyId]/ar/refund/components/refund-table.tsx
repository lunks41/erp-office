...
import { ArRefund } from "@/lib/api-routes"
...
export interface RefundTableProps {
  onRefundSelect: (selectedRefund: IArRefundHd | undefined) => void
...
export default function RefundTable({
  ...
  const {
    ...
    refetch: _refetchRefunds,
  } = useGetWithDatesAndPagination<IArRefundHd>(
    `${ArRefund.get}`,
    TableName.arRefund,
    searchQuery,
    searchStartDate ?? "",
  ...
  const handleSearchRefund = () => {
    ...
    const newFilters: IArRefundFilter = {
