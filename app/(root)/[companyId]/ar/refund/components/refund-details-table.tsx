  ...
  return (
    <div>
      <AccountReceiptBaseTable
        data={data}
        columns={visibleColumns as ColumnDef<IArRefundDt>[]}
        moduleId={ModuleId.ar}
        transactionId={ARTransactionId.refund}
        tableName={TableName.arRefundDt}
      ...
      <DeleteConfirmation
        ...
        description="This detail will be removed from the refund. This action cannot be undone."
      />
    </div>
  )
}
