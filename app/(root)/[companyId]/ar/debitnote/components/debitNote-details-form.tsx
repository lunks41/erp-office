...
>(
  (
    ...
    // Uses reusable helper function from ar-debitNote-calculations
    ...
    const onSubmit = async (_data: ArDebitNoteDtSchemaType) => {
      try {
        ...
        const validationResult = ArDebitNoteDtSchema(
          required,
          visible
        ...
        if (!validationResult.success) {
          ...
          validationResult.error.issues.forEach((issue) => {
            const fieldPath = issue.path.join(
              "."
            ) as keyof ArDebitNoteDtSchemaType
        ...
        const rowData: IArDebitNoteDt = {
          ...
          suppDebitNoteNo: updatedData.suppDebitNoteNo ?? "",
          apDebitNoteId: updatedData.apDebitNoteId ?? "0",
          apDebitNoteNo: updatedData.apDebitNoteNo ?? "",
