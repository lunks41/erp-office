...
const DebitNoteDetailsForm = React.forwardRef<
...
>(
  (
    ...
    const populateCodeNameFields = (
      formData: ApDebitNoteDtSchemaType
    ): ApDebitNoteDtSchemaType => {
    ...
    // Uses reusable helper function from ap-debitNote-calculations
    ...
    const onSubmit = async (_data: ApDebitNoteDtSchemaType) => {
      try {
        ...
        const validationResult = ApDebitNoteDtSchema(
          required,
          visible
        ...
        const rowData: IApDebitNoteDt = {
          debitNoteId: updatedData.debitNoteId ?? "0",
          ...
          custDebitNoteNo: updatedData.custDebitNoteNo ?? "",
          arDebitNoteId: updatedData.arDebitNoteId ?? "0",
          arDebitNoteNo: updatedData.arDebitNoteNo ?? "",
...
DebitNoteDetailsForm.displayName = "DebitNoteDetailsForm"

export default DebitNoteDetailsForm
