...
import { ApCreditNoteHdSchemaType } from "@/schemas"
...
export default function History({ form, isEdit: _isEdit }: HistoryProps) {
  ...
  return (
    <div className="divide-y divide-border/60 pb-1">
      ...
      <PaymentDetails creditNoteId={form.getValues().creditNoteId || ""} />
      <GLPostDetails creditNoteId={form.getValues().creditNoteId || ""} />
      <EditVersionDetails creditNoteId={form.getValues().creditNoteId || ""} />
    </div>
  )
}
