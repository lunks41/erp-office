...
export const ArInvoiceCtmHdSchema = (
  ...
  return z.object({
    ...
    data_details: z
      ...
      .min(1, "At least one invoice ctm detail is required"),
  })
}

export type ArInvoiceCtmHdSchemaType = z.infer<
  ReturnType<typeof ArInvoiceCtmHdSchema>
>

export const ArInvoiceCtmHdFiltersSchema = z.object({
  isActive: z.boolean().optional(),
  search: z.string().optional(),
  sortOrder: z.enum(["asc", "desc"]).optional(),
})

export type ArInvoiceCtmHdFiltersValues = z.infer<
  typeof ArInvoiceCtmHdFiltersSchema
>

export const ArInvoiceCtmDtSchema = (
  required: IMandatoryFields,
  visible: IVisibleFields
) => {
  return z.object({
...
export type ArInvoiceCtmDtSchemaType = z.infer<
  ReturnType<typeof ArInvoiceCtmDtSchema>
>

export const ArInvoiceCtmDtFiltersSchema = z.object({
  isActive: z.boolean().optional(),
  search: z.string().optional(),
  sortOrder: z.enum(["asc", "desc"]).optional(),
})

export type ArInvoiceCtmDtFiltersValues = z.infer<
  typeof ArInvoiceCtmDtFiltersSchema
>
